...
public class LiveModuleY extends Module implements Component {
    ...
    public boolean cross(int x, int y, int w, int h) {
        return (x >= getX() && x <= getX() + LiveModuleY.w && y >= getY() && y <= getY() + LiveModuleY.h) ||
